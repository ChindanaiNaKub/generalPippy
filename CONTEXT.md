...
| **Budget guidance** | Non-authoritative guidance from `/budget` about model routing and token efficiency. Exact token usage and cost belong to OpenCode's own session usage display. |
