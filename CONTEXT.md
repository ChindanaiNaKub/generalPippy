...
| **Guardrail candidate** | A proposed deterministic safety or workflow rule for the Pippy harness, backed by repeated run evidence and reviewed before becoming any hook, script, or platform-specific enforcement. _Avoid_: runtime hook, prompt preference, automatic blocker |
