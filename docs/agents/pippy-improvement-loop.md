...
2. **Review the Improvement Signal.** The Improvement Signal field identifies Pippy-owned friction — problems in Pippy's own prompts, routing logic, acceptance-criteria shaping, context assembly, Program design handling, or verification habits. It is always present and limited to Pippy-owned friction.
