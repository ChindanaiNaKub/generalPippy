...
| Slash commands | `config/commands/goal.md`, `config/commands/grill-to-goal.md`, `config/commands/ship.md`, `config/commands/budget.md`, `config/commands/advice.md` | User-facing entry points, output contracts, Goal readiness clarification, budget guidance, advisor requests, and ship workflow shortcuts |
