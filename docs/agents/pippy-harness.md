...
| Model profiles | `config/model-profiles/budget.json`, `config/model-profiles/thorough.json`, `install.sh`, `docs/adr/0005-model-profiles-and-read-only-advisor-agents.md`, `docs/adr/0013-remove-advisor-adapters.md` | Coordination/planning/implementation/system model defaults |
